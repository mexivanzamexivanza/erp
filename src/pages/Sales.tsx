...
export default function Sales() {
  ...
  async function createOrder() {
    ...
    try {
      ...
      await createSalesOrder({ customer_id: customerId, customer_name: customer?.name ?? "", lines: draftLines.map(l => ({ product_id: l.product_id, sku: l.sku, name: l.name, qty: l.qty, price: l.price })) });
